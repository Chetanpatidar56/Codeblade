...
import { Link, useNavigate } from 'react-router-dom';
import { useDispatch, useSelector } from "react-redux";
import { registerUser, clearError, resetLoading } from "../utilis/authSlice"; // Add resetLoading
...
const Signup = () => {
  ...
  // Clear error and reset loading on component mount
  useEffect(() => {
    dispatch(clearError());
    dispatch(resetLoading()); // Add this line
  }, [dispatch]);
