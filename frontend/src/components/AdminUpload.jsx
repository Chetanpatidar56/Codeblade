...
function AdminUpload(){ 
    ...
    const [uploadingProgess,setUploadingProgress]=useState(0);
    ...
    const onSubmit=async(data)=>{
        ...
        try{
            ...
            reset();//once a video successfully uploaded, reset it for another video upload
        ...
        <div className="max-w-md mx-auto p-6">
            <div className="card bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            {...register('videoFile',{
                                ...
                                validate:{
                                    isVideo:(files)=>{
                                        ...
                                        return files[0].type.startsWith('video/') || 'Please select a video file'
                                    },
                                    fileSize:(files)=>{
                                        if(!files || !files[0])
                                            return true;
                                        const file=files[0];
                                        const maxSize=100*1024*1024; //is actually 100 MB --> 1 MB= 1024 KB, 1 KB= 1024 Bytes
                        ...
                        {uploading && (
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    <span>Uploading...</span>
                                    <span>{uploadingProgess}</span>
                                </div>
                                <progress className="progress progress-primary w-full"
                                value={uploadingProgess}
                                max="100"></progress>
                            </div>
                        ...
                        {uploadedVideo && (
                            <div className="alert alert-success">
                                <div>
                                    <h3 className="font-bold">Upload Successfull</h3>
                    ...
                    {/* {uploadedVideo && uploadedVideo.thumbnailUrl && (
                        <div className="mt-4">
                            <h3 className="font-bold mb-2">Video Thumbnail:</h3>
                            <img src={uploadedVideo.thumbnailUrl} 
                                 alt="Video thumbnail" 
